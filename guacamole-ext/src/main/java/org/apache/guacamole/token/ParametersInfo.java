...
/**
 * Information which describes a valid parameter
 */
public class ParametersInfo {
    ...
    /**
     * Creates a new ParametersInfo object which requires the given fields for
     * any conforming parameters.
     *
     * @param fields
    ...
    /**
     * Returns all fields required for valid parameters as described by this
     * object.
     *
     * @return
     *     All fields required for valid parameters.
    ...
    /**
     * A field describing the hostname parameter expected by Guacamole
     * during a connection.
     */
    ...
    /**
     * A field describing the username parameter expected by Guacamole
     * during a connection.
     */
    public static final Field USERNAME = new UsernameField("username");

    /**
     * A field describing the password parameter expected by Guacamole
     * during a connection.
     */
