 ...
 * connecting to a Oracle database based on Oracle-specific options
 * provided via guacamole.properties.
 */
public class OracleInjectorProvider extends JDBCInjectorProvider {
    ...
    protected Injector create() throws GuacamoleException {
        ...
        return Guice.createInjector(
            ...
            new OracleAuthenticationProviderModule(environment)
        );
